  ...
  routes: [
    { path: '/login', component: () => import('@/views/login/LoginView.vue') },
    {
      ...
      children: [
        ...
        { path: 'system/role', component: () => import('@/views/system/RoleManageView.vue') },
        { path: 'system/menu', component: () => import('@/views/system/MenuManageView.vue') },
        { path: 'system/operate-log', component: () => import('@/views/system/OperateLogListView.vue') },
        { path: 'system/file', component: () => import('@/views/system/FileManageView.vue') },
