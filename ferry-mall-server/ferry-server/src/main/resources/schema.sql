...
CREATE INDEX IF NOT EXISTS idx_sys_operate_log_tenant ON sys_operate_log(tenant_id);
CREATE INDEX IF NOT EXISTS idx_sys_operate_log_created ON sys_operate_log(created_at);
...
CREATE INDEX IF NOT EXISTS idx_sys_file_tenant ON sys_file(tenant_id);
